...
-- select PEDIDO_FECHA, USUARIO_DNI,REPARTIDOR_DNI, LOCAL_LOCALIDAD, LOCAL_PROVINCIA, REPARTIDOR_DIRECION from gd_esquema.Maestra WHERE REPARTIDOR_DNI = 30107431 and PEDIDO_FECHA = '2024-01-20 08:00:00.117'

-- select * from gd_esquema.Maestra Where LOCAL_DIRECCION = 'Avenida Costanera Rafael Obligado4341' or ENVIO_MENSAJERIA_DIR_DEST = 'Avenida Costanera Rafael Obligado4341' or ENVIO_MENSAJERIA_DIR_ORIG = 'Avenida Costanera Rafael Obligado4341'
